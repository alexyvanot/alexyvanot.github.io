...
const Assets = {
	...
	TypeScript: asset('typescript-original.svg'),
	...
	Express: asset('express.png'),
	JavaScript: asset('javascript-original.svg'),
	Fastify: asset('fastify.svg'),
	...
	PostgreSQL: asset('postgresql-original.svg'),
	...
	TailwindCSS: asset('tailwindcss-original.svg'),
	HTML: asset('html.svg'),
	...
	Arduino: asset('arduino-original.svg'),
	DotNet: asset('dotnet-original.svg'),
	Grafana: asset('grafana-original.svg'),
	Hugo: asset('hugo-original.svg'),
	Ionic: asset('ionic-original.svg'),
	MariaDB: asset('mariadb-original.svg'),
	MySQL: asset('mysql-original.svg'),
	OpenCV: asset('opencv-original.svg'),
	Oracle: asset('oracle-original.svg'),
	PHP: asset('php-original.svg'),
	Postman: asset('postman-original.svg'),
