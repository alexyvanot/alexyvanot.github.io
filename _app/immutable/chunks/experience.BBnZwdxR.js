import{A as t}from"./assets.DKObicWd.js";import{a as i}from"./skills.BxtAH9AO.js";var n=(e=>(e.FullTime="Full-time",e.PartTime="Part-time",e.SelfEmployed="Self-employed",e.Freelance="Freelance",e.Contract="Contract",e.Internship="Internship",e.Apprenticeship="Apprenticeship",e))(n||{});const s=`## 🧪 Full‑Stack Developer – Synchrotron SOLEIL (Work-Study)
...
`,o=`## 🛠️ Développeur Web – AGH Bâtiment (Stage)
...
`,r="Expérience",a=[{slug:"fullstack-synchrotron-soleil",company:"Synchrotron SOLEIL",description:s,contract:n.Apprenticeship,type:"Développement Full-Stack",location:"Saint-Aubin, France",period:{from:new Date(2023,8,1)},skills:i("java","react","node","docker","ci","linux"),name:"Full-Stack Developer",color:"orange",links:[{to:"https://www.synchrotron-soleil.fr/",label:"Site Web",newTab:!0}],logo:t.Soleil,shortDescription:"Développement full-stack et automatisation au Synchrotron SOLEIL"},{slug:"stagiaire-aghb",company:"AGH Bâtiment",description:o,contract:n.Internship,type:"Développement Web",location:"France",period:{from:new Date(2022,7,1),to:new Date(2022,7,31)},skills:i("html","css","js","svg"),name:"Stagiaire – Rénovation administrative",color:"teal",links:[],logo:t.AGH,shortDescription:"Stage de développement web & logo chez AGH Bâtiment"}],p={title:r,items:a};export{p as E};
