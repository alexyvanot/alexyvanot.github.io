import{A as e}from"./assets.DKObicWd.js";const n=`## 🎓 ESIEA – Master en ingénierie informatique
...
`,i=`## 💻 InTech – Bachelor en ingénierie informatique
...
`,t=`## 🧬 Lycée Pierre Mendès France – Baccalauréat général
...
`,o="Formation",r=[{degree:"Master en ingénierie informatique",description:n,location:"France",logo:e.ESIEA,name:"ESIEA",organization:"ESIEA",period:{from:new Date(2024,0,1),to:new Date(2026,5,1)},shortDescription:"Diplôme RNCP Niveau 7 (Bac+5)",slug:"master-esiea",subjects:[],links:[{label:"Site web ESIEA",to:"https://www.esiea.fr",newTab:!0}],color:"deepskyblue"},{degree:"Bachelor en ingénierie informatique",description:i,location:"France",logo:e.InTech,name:"InTech",organization:"InTech",period:{from:new Date(2021,0,1),to:new Date(2023,5,1)},shortDescription:"Diplôme Bac+3 en génie informatique",slug:"bachelor-intech",subjects:[],links:[{label:"Site web InTech",to:"https://www.intechinfo.fr",newTab:!0}],color:"limegreen"},{degree:"Baccalauréat (SVT / SES)",description:t,location:"Savigny-le-Temple, France",logo:e.PMF,name:"Pierre Mendès France",organization:"Lycée Pierre Mendès France",period:{from:new Date(2017,8,1),to:new Date(2020,6,1)},shortDescription:"Spécialisation Sciences de la Vie, Terre & Sciences Éco.",slug:"bac-pmf-2020",subjects:["SVT","SES"],links:[{label:"Site Web PMF",to:"https://www.lyceepmf-savigny77.fr",newTab:!0}],color:"moccasin"}],s={title:o,items:r};export{s as E};
